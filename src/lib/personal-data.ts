...
const PERSONAL_CHARACTER_SEEDS: PersonalCharacterSeed[] = [
  ...
  { id: "francesgaz", name: "FranCesGaz", groupId: "alp", level: 243 },
  { id: "queenofferia", name: "QueenofFeria", groupId: "alp", level: 243, aliases: ["queen0feria"] },
  { id: "khrasedraalp", name: "KhrasedraALP", groupId: "alp", level: 243, note: "Never run" },
  { id: "archangelpluz", name: "ArchAngelpluZ", groupId: "alp", level: 243 },
  { id: "jessigazalp", name: "JessiGazALP", groupId: "alp", level: 250, aliases: ["jessigaalp"] },
  { id: "izanoalp", name: "IzanoALP", groupId: "alp", level: 243 },
  { id: "souffleextreme", name: "SouffleExtreme", groupId: "alp", level: 242, aliases: ["soufflextreme"] },
  { id: "poweroffranz", name: "PoWerofFranZ", groupId: "alp", level: 243, aliases: ["power0franz"] },
  { id: "reginaalp", name: "ReginaALP", groupId: "alp", level: 243 },
  { id: "junoirextreme", name: "JunoirExtreme", groupId: "alp", level: 243 },
