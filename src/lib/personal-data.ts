...
const PERSONAL_CHARACTER_SEEDS: PersonalCharacterSeed[] = [
  { id: "chronos", name: "CHRONOS", groupId: "main", level: 238 },
  { id: "molloreena", name: "MOLLOREENA", groupId: "main", level: 236 },
  { id: "kimrei", name: "KIMREI", groupId: "main", level: 235 },
  { id: "hazele", name: "HAZELE", groupId: "main", level: 236 },
  { id: "andromeche", name: "ANDROMECHE", groupId: "main", level: 234 },
  { id: "felishar", name: "FELISHAR", groupId: "main", level: 235 },
  { id: "karella", name: "KARELLA", groupId: "main", level: 236 },
  { id: "queenight", name: "QUEENIGHT", groupId: "main", level: 236 },
  { id: "xenodice", name: "XENODICE", groupId: "main", level: 240 },
  { id: "vanesfranca", name: "VANESFRANCA", groupId: "main", level: 201 },
  { id: "pinaaya", name: "PINAAYA", groupId: "main", level: 239 },

  { id: "francesgaz", name: "FranCesGaz", groupId: "alp", level: 237 },
  { id: "queenofferia", name: "QueenofFeria", groupId: "alp", level: 240, aliases: ["queen0feria"] },
  { id: "khrasedraalp", name: "KhrasedraALP", groupId: "alp", level: 240, note: "Never run" },
  { id: "archangelpluz", name: "ArchAngelpluZ", groupId: "alp", level: 239 },
  { id: "jessigazalp", name: "JessiGazALP", groupId: "alp", level: 250, aliases: ["jessigaalp"] },
  { id: "izanoalp", name: "IzanoALP", groupId: "alp", level: 237 },
  { id: "souffleextreme", name: "SouffleExtreme", groupId: "alp", level: 233, aliases: ["soufflextreme"] },
  { id: "poweroffranz", name: "PoWerofFranZ", groupId: "alp", level: 235, aliases: ["power0franz"] },
  { id: "reginaalp", name: "ReginaALP", groupId: "alp", level: 236 },
  { id: "junoirextreme", name: "JunoirExtreme", groupId: "alp", level: 238 },
  { id: "soulalp", name: "SoulALP", groupId: "alp", level: 200 },

  { id: "catharina", name: "CATHARINA", groupId: "dancer", level: 240 },
  { id: "achilla", name: "ACHILLA", groupId: "dancer", level: 236 },
  { id: "viorna", name: "VIORNA", groupId: "dancer", level: 239 },
  { id: "reefa-id-4", name: "REEFA", groupId: "dancer", level: 219, note: "id 4", aliases: ["reefa"] },
  ...
  { id: "nongbaby", name: "NongBaby", groupId: "friends", level: 235 },
...
function buildProfile(seed: PersonalCharacterSeed, override?: Partial<StoredPersonalCharacterProfile>): PersonalCharacterProfile {
  ...
  return {
    ...
    level: Math.max(1, Math.floor(override?.level ?? seed.level)),
    groupId,
